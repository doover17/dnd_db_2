...
# 1) Inspector: subclasses schema + sample rows
cat > tools/inspect_subclasses.py <<'PY'
#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
PY
chmod +x tools/inspect_subclasses.py

# 2) Overwrite tools/apply_subclass_features.py with schema-adaptive lookup
...
echo "==> Added tools/inspect_subclasses.py and overwrote tools/apply_subclass_features.py (schema-adaptive)."
echo "Next run:"
echo "  python tools/inspect_subclasses.py"
